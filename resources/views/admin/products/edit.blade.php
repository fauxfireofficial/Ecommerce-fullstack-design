            ...
            <div class="form-grid">
                ...
                <div class="form-column">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div style="display: flex; align-items: center; gap: 10px; margin-top: 5px;">
                                <label class="switch">
                                    <input type="checkbox" name="is_free_shipping" value="1" {{ old('is_free_shipping', $product->is_free_shipping) ? 'checked' : '' }} onchange="document.getElementById('shipping_fees_div').style.display = this.checked ? 'none' : 'block'">
                    ...
                    <div id="shipping_fees_div" style="display: {{ old('is_free_shipping', $product->is_free_shipping) ? 'none' : 'block' }};">
                        <div class="form-row">
                            <div class="form-group">
                                <label for="shipping_fee_national">National Delivery Fee</label>
                                <div class="input-prefix">
                                    <span>$</span>
                                    <input type="number" id="shipping_fee_national" name="shipping_fee_national" class="form-control" step="0.01" value="{{ old('shipping_fee_national', $product->shipping_fee_national) }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-prefix">
                                    <span>$</span>
                                    <input type="number" id="shipping_fee_international" name="shipping_fee_international" class="form-control" step="0.01" value="{{ old('shipping_fee_international', $product->shipping_fee_international) }}">
                                </div>
                ...
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="search_tags" name="search_tags" class="form-control" value="{{ old('search_tags', $product->search_tags) }}" placeholder="Mobile, Apple, iOS, Smartphone">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="meta_title" name="meta_title" class="form-control" value="{{ old('meta_title', $product->meta_title) }}" placeholder="Optimized Title for Search Engines">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3" class="form-control" placeholder="Brief description for search engine results">{{ old('meta_description', $product->meta_description) }}</textarea>
