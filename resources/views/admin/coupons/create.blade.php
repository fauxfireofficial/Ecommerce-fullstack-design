                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group-premium">
                            ...
                            <input type="text" name="code" class="form-control-premium" value="{{ old('code') }}" required placeholder="e.g. WELCOME100">
                    ...
                    <div class="col-md-6">
                        <div class="input-group-premium">
                            ...
                            <input type="number" step="0.01" name="value" class="form-control-premium" value="{{ old('value') }}" required placeholder="0.00">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group-premium">
                            ...
                            <input type="number" step="0.01" name="min_purchase" class="form-control-premium" value="{{ old('min_purchase', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group-premium">
                            ...
                            <input type="number" name="usage_limit" class="form-control-premium" value="{{ old('usage_limit') }}" placeholder="Unlimited if blank">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group-premium">
                            ...
                            <input type="date" name="expires_at" class="form-control-premium" value="{{ old('expires_at') }}">
                        </div>
                    </div>
                </div>
