...
<style>
    ...
    .card-info h4 { font-size: 16px; font-weight: 700; margin-bottom: 15px; height: 40px; overflow: hidden; }
    ...
    <section class="products-section container">
        ...
        <div class="gift-grid">
            ...
            <div class="product-card">
                ...
                <div class="card-info">
                    <span style="font-size: 11px; font-weight: 700; color: var(--primary); text-transform: uppercase;">{{ $product->category }}</span>
                    <h4>{{ $product->name }}</h4>
            ...
            <div class="product-card">
                ...
                <div class="img-wrap">
                    <img src="https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=500&auto=format&fit=crop&q=60" alt="Midnight Surprise">
                </div>
                <div class="card-info">
                    <span style="font-size: 11px; font-weight: 700; color: var(--primary); text-transform: uppercase;">Celebration</span>
            ...
            <div class="product-card">
                ...
                <div class="img-wrap">
                    <img src="https://images.unsplash.com/photo-1512909006721-3d6018887183?w=500&auto=format&fit=crop&q=60" alt="Morning Joy">
                </div>
                <div class="card-info">
                    <span style="font-size: 11px; font-weight: 700; color: var(--primary); text-transform: uppercase;">Morning</span>
            ...
            <div class="product-card">
                ...
                <div class="img-wrap">
                    <img src="https://images.unsplash.com/photo-1513201099705-a9746e1e201f?w=500&auto=format&fit=crop&q=60" alt="Sweet Harmony">
                </div>
                <div class="card-info">
                    <span style="font-size: 11px; font-weight: 700; color: var(--primary); text-transform: uppercase;">Luxury</span>
