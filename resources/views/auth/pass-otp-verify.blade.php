...
<div class="auth-container">
    <div class="auth-card">
        ...
        <div class="auth-body">
            ...
            <form action="{{ route('password.verify.submit') }}" method="POST" class="auth-form" id="passOtpForm">
                @csrf
                <div class="form-group text-center">
                    ...
                    <input type="hidden" name="otp" id="fullPassOtp">
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const fullOtpInput = document.getElementById('fullPassOtp');
